...
> **See also (root canonical strategy)**: `../../docs/technical/postgres-substitution-strategy.md` — the cross-project Postgres/Supabase substitution strategy. This doc keeps Libra Keeper-specific migration scope and schema deltas only.
