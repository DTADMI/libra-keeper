CREATE TABLE IF NOT EXISTS rate_limits (
  id BIGSERIAL PRIMARY KEY, identifier TEXT NOT NULL, route TEXT NOT NULL,
  window_start TIMESTAMPTZ NOT NULL DEFAULT NOW(), count INTEGER NOT NULL DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS feature_flags (
  ...
  type TEXT NOT NULL DEFAULT 'boolean', value JSONB, rules JSONB,
  updated_at TIMESTAMPTZ NOT NULL DEFAULT NOW(), updated_by TEXT
);
INSERT INTO feature_flags (name, enabled, type, value) VALUES ('pg_rate_limit', true, 'boolean', 'true'), ('pg_flags', false, 'boolean', 'false') ON CONFLICT (name) DO NOTHING;
...
AS $$
DECLARE v_window_start TIMESTAMPTZ; v_count INTEGER; v_allowed BOOLEAN; v_remaining INTEGER; v_oldest TIMESTAMPTZ; v_reset_at TIMESTAMPTZ;
BEGIN
